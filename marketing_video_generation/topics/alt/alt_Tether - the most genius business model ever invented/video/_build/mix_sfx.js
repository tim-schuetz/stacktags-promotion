...
// Reads the page's DECLARED sound bed (capture/sfx.json, dumped by capture.js
// from window.SFX) and overlays each cue onto script_voice.mp3 with ffmpeg:
// each sound delayed to its narration time t, scaled to its vol, summed
// (normalize=0 → voice keeps full level) and soft-limited.
// Output → capture/narration_sfx.m4a (muxed by mux.js).
