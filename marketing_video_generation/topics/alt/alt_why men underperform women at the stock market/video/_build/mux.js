// Mux the recorded webm (video) + narration (audio) into the final mp4,
...
const out = path.resolve(BUILD, '../why-men-underperform-women.mp4');
...
console.log('preroll trim =', preroll.toFixed(3), 's   audio =', path.basename(mp3));
...
const args = [
  ...
  '-c:a', 'aac', '-b:a', '192k',
  // hold the assembled outro for a beat after the last spoken word
  '-af', 'apad', '-t', '108.5',
  '-movflags', '+faststart',
  out,
];
