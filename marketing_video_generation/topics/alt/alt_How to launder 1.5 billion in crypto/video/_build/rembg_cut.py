# Background-remove the raw renders in ../assets/raw to transparent cut-outs in
# ../assets/photos using rembg (u2net). Then autocrop + light feather.
import os, sys
...
keys = sys.argv[1:] or ['hacker_loot', 'hacker_stuck', 'coin', 'tumbler']
