# Cut out the woman (rembg) then bake a dashed turquoise outline -> woman_dashed.png.
import os, math
import numpy as np
...
out.save(os.path.join(IMG, 'woman_dashed.png'))
print('saved woman_dashed', out.size)
