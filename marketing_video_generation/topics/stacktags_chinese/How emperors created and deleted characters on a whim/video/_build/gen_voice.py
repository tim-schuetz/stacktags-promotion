...
TEXT = (
    ...
    "And it ran the other way, too — rulers could invent characters. You might wonder: "
    "there was a female emperor? Yes — and it was the only one in China's "
    "five-thousand-year history of dynasties: Wu Zetian. And as women are creative in "
    "design, she used her powers to invent a whole set of new characters. The most "
    "famous was her own name: jaow — built from the characters for sun and moon, "
    "shining over the sky. Sun and moon in the heavens. A character she designed, for "
    "herself. Most of her inventions vanished after she died — but the idea behind "
    "them was very real: the writing itself was the ruler's to shape.\n\n"
    "And sometimes, like with Guan-yin, that royal edit is still on everyone's lips, a "
    "thousand years later. Wanna actually start learning Chinese? Discover thousands "
    "of free exercises and more learning content on stacktags.io."
)
