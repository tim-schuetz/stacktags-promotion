// Render the thumbnail at 2x via the cached Chromium (downscaled afterwards with ffmpeg).
...
(async () => {
  ...
  await page.goto('http://localhost:8878/thumbnail/thumbnail.html', { waitUntil: 'networkidle' });
