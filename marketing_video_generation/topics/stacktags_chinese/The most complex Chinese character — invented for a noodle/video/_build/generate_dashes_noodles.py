# Trace the cut-out noodle bowl's silhouette and bake a dashed turquoise outline,
# offset slightly outward. Output: noodles_dashed.png (+ capture/dash_preview_noodles.png).
import os, math
import numpy as np
...
im = Image.open(os.path.join(IMG, 'noodles_cut.png')).convert('RGBA')
W, H = im.size
alpha = np.array(im)[:, :, 3]
