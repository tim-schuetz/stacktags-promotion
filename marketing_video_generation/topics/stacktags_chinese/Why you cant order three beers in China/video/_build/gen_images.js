...
const SHOTS = [
  ...
  { key: 'dog', ar: '1:1',
    prompt: 'A single cute adult Shiba Inu dog sitting, full body, facing the camera, alert friendly expression, fluffy tan-and-white fur, studio pet photography.' },
  { key: 'book', ar: '1:1',
    prompt: 'A single closed hardcover book standing slightly angled, plain solid-colour teal cover with no readable text, clean modern design, gentle three-quarter product view.' },
  { key: 'apple', ar: '1:1',
    prompt: 'A single fresh red apple with a short brown stem and one small green leaf, glossy skin, straight-on product view.' },
];
