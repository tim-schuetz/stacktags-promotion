...
const SHOTS = [
  ...
  // homophone scene: mother / horse / scold (妈 / 马 / 骂) — real images, cut out
  { key: 'ho_mother', ratio: '3:4', person: true, prompt: 'A warm, gentle photorealistic portrait of a caring East Asian mother in her late thirties, soft loving motherly smile, wearing a cozy knit cardigan, hands resting warmly over her chest, calm tender expression, upper body, isolated on a plain solid pure white background, soft even lighting.' },
  { key: 'ho_horse', ratio: '4:3', person: false, prompt: 'A photorealistic light-brown horse standing in clean side profile, full body visible, calm, isolated on a plain solid pure white background, soft even lighting.' },
  { key: 'ho_scold', ratio: '3:4', person: true, prompt: 'A photorealistic stern, visibly angry middle-aged East Asian woman scolding — frowning, mouth open mid-shout, raising and wagging her index finger, expressive, upper body, isolated on a plain solid pure white background, soft even lighting.' },
  // "and the Dungan have done exactly that for generations" — a new multi-generation family
  { key: 'dungan_family', ratio: '4:3', person: true, prompt: 'A photorealistic group of Dungan adults of three different ages — Hui Chinese Muslims of Kyrgyzstan, East Asian features: an elderly grandfather with a white embroidered skullcap and a grey beard, a middle-aged man, and a younger woman in a simple plain headscarf — standing close together with warm genuine smiles, full body, isolated on a plain solid light grey background, soft even studio lighting.' },
];
