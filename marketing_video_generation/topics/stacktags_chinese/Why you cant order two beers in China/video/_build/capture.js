...
const END = 85.5;   // break shortly before the narration ends (≈86.52s); the 4s tail covers the outro hold
...
(async () => {
  ...
  await page.goto('http://localhost:8888/video/index.html', { waitUntil: 'domcontentloaded' });
  await page.evaluate(async () => { try { await document.fonts.ready; } catch {} });
  await page.waitForFunction(() => window.__ready === true, { timeout: 15000 }).catch(() => console.log('  (maps not flagged ready — continuing)'));
