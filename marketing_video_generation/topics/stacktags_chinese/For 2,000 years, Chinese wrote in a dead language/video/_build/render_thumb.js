// Screenshot the thumbnail page at 1280x720 (2x) -> thumbnail/thumbnail.png
...
(async () => {
  ...
  await page.goto('http://localhost:8894/thumbnail/thumbnail.html', { waitUntil: 'domcontentloaded' });
