...
TEXT = (
    ...
    "You just pick the right one. So all day long, you only have to recognize the "
    "correct character. Never build it from memory, stroke by stroke. And recognition "
    "is easy. Active recall — producing the whole thing from scratch — is hard. "
    ...
    "to a keyboard...\n\n"
    "Want to actually start learning Chinese? Discover thousands of free exercises "
