...
// Serve through the topic server (node ../video/_build/server.js on :8863).
...
(async () => {
  ...
  await page.goto('http://localhost:8863/thumbnail/Thumbnail.html', { waitUntil: 'domcontentloaded' });
