// Same as mux.js but writes the pure-animation output to ...orig.mp4
// (the avatar-composited main .mp4 is produced by a separate step).
...
const out = path.resolve(BUILD, '../how-to-launder-1-5-billion-in-crypto.orig.mp4');
