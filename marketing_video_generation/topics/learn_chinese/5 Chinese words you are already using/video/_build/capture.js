...
const END = 125.6;   // narration length (script_audio.mp3 ≈ 125.81s)
...
(async () => {
  ...
  // let fonts + the first beat settle
  ...
  // ALWAYS close the browser — even on a transient crash — so no orphaned chrome.exe piles up
